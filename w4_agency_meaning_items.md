# Agency & Meaning Items — 3-Path Overview

Scale: Strongly disagree / Disagree / Slightly disagree / Slightly agree / Agree / Strongly agree

**Paths:** A = uses AI for work/school | B = uses AI for personal only | C = never used AI

---

## Child / Gen Z Survey

| Construct | Path A (work/school) | Path B (personal) | Path C (never used — hypothetical) |
|-----------|---------------------|-------------------|-------------------------------------|
| **Process agency (negative)** | | | |
| Less say | When I use AI, I feel like I have **less say** in how my work gets done. | When I use AI, I feel like I have **less control** over how things in my personal life get done. | If I used AI, I think I would have **less say** in how my work gets done. |
...
| Bigger challenges | AI makes me feel like I can **take on bigger challenges** at work. | AI makes me feel like I can **take on bigger challenges** in my personal life. | If I used AI, I think I could **take on bigger challenges** at work. |
...
## Dependency (Paths A & B only — no Path C)

| Item | Path A (work/school) | Path B (personal) |
|------|---------------------|-------------------|
| AI disappeared | If all AI tools suddenly disappeared, how well could you do your typical work? | If all AI tools suddenly disappeared, how well could you handle your typical everyday tasks? |
| Skill trajectory | Compared to 6 months ago, my ability to do work **without AI** has... | Compared to 6 months ago, my ability to handle everyday tasks **without AI** has... |

---

## Notes for Angela

- **Path C framing**: We chose neutral/hypothetical ("If I used AI, I think...") over causal ("I don't use AI because..."). Neutral isolates beliefs without assuming they drive non-use. Trade-off: may get more midpoint responses.
- **Positive process items** (in control, it's mine) are new rewrites to balance the negatively worded originals — avoids confounding item direction with process vs. outcome.
- **TENTATIVE items** (own thinking, higher quality) are candidates for cutting if the survey is too long.
- "Work" displays as "schoolwork" for respondents under 18.
